...
class Command(BaseCommand):
    help = 'Send an e-mail remainder to users registered more \
            than n number of days who are not enrolled into any courses yet'
    ...
    def handle(self, *args, **options):
        ...
        for user in users:
            message = """Dear {},
                We noticed that you didn;t enroll nin any courses yet.
